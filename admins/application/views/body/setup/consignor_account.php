...
<div id="content" class="content">
    ...
    <ol class="breadcrumb pull-right">
        ...
        <li class="breadcrumb-item active">Consignor Account</li>
    </ol>
    <!-- end breadcrumb -->
    <!-- begin page-header -->
    <h1 class="page-header">Setup <small>Consignor Account</small></h1>
    <!-- end page-header -->
        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <table id="dt_consignor_account" class="table table-bordered" width="100%">
                        <thead>
                            <tr>
                                <th></th>
                                <th>Consignor</th>
...
<div class="modal fade" id="supplier_account">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form id="consignor_account_form">
...
<script>
    ...
    function setup_supplier(id) {
        ...
        $.ajax({
            ...
            url: "<?php echo site_url('setup_consignor'); ?>",
            success: function(result) {
